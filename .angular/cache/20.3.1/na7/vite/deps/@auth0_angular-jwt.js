...
var _JwtHelperService = class _JwtHelperService {
...
__name(_JwtHelperService, "JwtHelperService");
var JwtHelperService = _JwtHelperService;
JwtHelperService.ɵfac = /* @__PURE__ */ __name(function JwtHelperService_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || JwtHelperService)(ɵɵinject(JWT_OPTIONS));
}, "JwtHelperService_Factory");
...
var fromPromiseOrValue = /* @__PURE__ */ __name((input) => {
...
__name(_JwtInterceptor, "JwtInterceptor");
var JwtInterceptor = _JwtInterceptor;
JwtInterceptor.ɵfac = /* @__PURE__ */ __name(function JwtInterceptor_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || JwtInterceptor)(ɵɵinject(JWT_OPTIONS), ɵɵinject(JwtHelperService), ɵɵinject(DOCUMENT));
}, "JwtInterceptor_Factory");
...
var _JwtModule = class _JwtModule {
...
__name(_JwtModule, "JwtModule");
var JwtModule = _JwtModule;
JwtModule.ɵfac = /* @__PURE__ */ __name(function JwtModule_Factory(__ngFactoryType__) {
