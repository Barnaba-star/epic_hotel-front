...
var _AsyncAnimationRendererFactory = class _AsyncAnimationRendererFactory {
   ...
   */
  loadImpl() {
    const loadFn = /* @__PURE__ */ __name(() => this.moduleImpl ?? import("./browser-6AVOTUHJ.js").then((m) => m), "loadFn");
...
__publicField(_AsyncAnimationRendererFactory, "ɵprov", ɵɵdefineInjectable({
