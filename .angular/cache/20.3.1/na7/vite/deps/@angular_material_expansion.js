...
} from "./chunk-YYL5CNEB.js";
import {
  _StructuralStylesLoader
} from "./chunk-W7255A3H.js";
import {
  CdkPortalOutlet,
  PortalModule,
  TemplatePortal
} from "./chunk-OZD35UO5.js";
import {
  _animationsDisabled
} from "./chunk-ACYI3TWD.js";
...
__name(_CdkAccordion, "CdkAccordion");
__publicField(_CdkAccordion, "ɵfac", /* @__PURE__ */ __name(function CdkAccordion_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _CdkAccordion)();
}, "CdkAccordion_Factory"));
__publicField(_CdkAccordion, "ɵdir", ɵɵdefineDirective({
  type: _CdkAccordion,
...
__name(_CdkAccordionItem, "CdkAccordionItem");
__publicField(_CdkAccordionItem, "ɵfac", /* @__PURE__ */ __name(function CdkAccordionItem_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _CdkAccordionItem)();
}, "CdkAccordionItem_Factory"));
__publicField(_CdkAccordionItem, "ɵdir", ɵɵdefineDirective({
...
__name(_CdkAccordionModule, "CdkAccordionModule");
__publicField(_CdkAccordionModule, "ɵfac", /* @__PURE__ */ __name(function CdkAccordionModule_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _CdkAccordionModule)();
}, "CdkAccordionModule_Factory"));
__publicField(_CdkAccordionModule, "ɵmod", ɵɵdefineNgModule({
  type: _CdkAccordionModule,
  imports: [CdkAccordion, CdkAccordionItem],
  exports: [CdkAccordion, CdkAccordionItem]
}));
__publicField(_CdkAccordionModule, "ɵinj", ɵɵdefineInjector({}));
...
__name(MatExpansionPanel_ng_template_7_Template, "MatExpansionPanel_ng_template_7_Template");
...
__name(MatExpansionPanelHeader_Conditional_4_Template, "MatExpansionPanelHeader_Conditional_4_Template");
...
__name(_MatExpansionPanelContent, "MatExpansionPanelContent");
__publicField(_MatExpansionPanelContent, "ɵfac", /* @__PURE__ */ __name(function MatExpansionPanelContent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _MatExpansionPanelContent)();
}, "MatExpansionPanelContent_Factory"));
__publicField(_MatExpansionPanelContent, "ɵdir", ɵɵdefineDirective({
...
var _MatExpansionPanel = class _MatExpansionPanel extends CdkAccordionItem {
  ...
  _transitionEndListener = /* @__PURE__ */ __name(({
    target,
    propertyName
  }) => {
...
__name(_MatExpansionPanel, "MatExpansionPanel");
__publicField(_MatExpansionPanel, "ɵfac", /* @__PURE__ */ __name(function MatExpansionPanel_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _MatExpansionPanel)();
}, "MatExpansionPanel_Factory"));
__publicField(_MatExpansionPanel, "ɵcmp", ɵɵdefineComponent({
  type: _MatExpansionPanel,
  selectors: [["mat-expansion-panel"]],
  contentQueries: /* @__PURE__ */ __name(function MatExpansionPanel_ContentQueries(rf, ctx, dirIndex) {
    if (rf & 1) {
  ...
  }, "MatExpansionPanel_ContentQueries"),
  viewQuery: /* @__PURE__ */ __name(function MatExpansionPanel_Query(rf, ctx) {
    if (rf & 1) {
      ɵɵviewQuery(_c0, 5);
      ɵɵviewQuery(_c1, 5);
    }
  ...
  }, "MatExpansionPanel_Query"),
  hostAttrs: [1, "mat-expansion-panel"],
  hostVars: 4,
  hostBindings: /* @__PURE__ */ __name(function MatExpansionPanel_HostBindings(rf, ctx) {
    if (rf & 2) {
      ɵɵclassProp("mat-expanded", ctx.expanded)("mat-expansion-panel-spacing", ctx._hasSpacing());
    }
  }, "MatExpansionPanel_HostBindings"),
  inputs: {
  ...
  template: /* @__PURE__ */ __name(function MatExpansionPanel_Template(rf, ctx) {
    if (rf & 1) {
      ɵɵprojectionDef(_c2);
      ɵɵprojection(0);
...
__name(_MatExpansionPanelActionRow, "MatExpansionPanelActionRow");
__publicField(_MatExpansionPanelActionRow, "ɵfac", /* @__PURE__ */ __name(function MatExpansionPanelActionRow_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _MatExpansionPanelActionRow)();
}, "MatExpansionPanelActionRow_Factory"));
__publicField(_MatExpansionPanelActionRow, "ɵdir", ɵɵdefineDirective({
...
__name(_MatExpansionPanelHeader, "MatExpansionPanelHeader");
__publicField(_MatExpansionPanelHeader, "ɵfac", /* @__PURE__ */ __name(function MatExpansionPanelHeader_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _MatExpansionPanelHeader)();
}, "MatExpansionPanelHeader_Factory"));
__publicField(_MatExpansionPanelHeader, "ɵcmp", ɵɵdefineComponent({
  type: _MatExpansionPanelHeader,
  selectors: [["mat-expansion-panel-header"]],
  hostAttrs: ["role", "button", 1, "mat-expansion-panel-header", "mat-focus-indicator"],
  hostVars: 13,
  hostBindings: /* @__PURE__ */ __name(function MatExpansionPanelHeader_HostBindings(rf, ctx) {
    if (rf & 1) {
      ɵɵlistener("click", /* @__PURE__ */ __name(function MatExpansionPanelHeader_click_HostBindingHandler() {
        return ctx._toggle();
      }, "MatExpansionPanelHeader_click_HostBindingHandler"))("keydown", /* @__PURE__ */ __name(function MatExpansionPanelHeader_keydown_HostBindingHandler($event) {
        return ctx._keydown($event);
      }, "MatExpansionPanelHeader_keydown_HostBindingHandler"));
    }
    if (rf & 2) {
  ...
  template: /* @__PURE__ */ __name(function MatExpansionPanelHeader_Template(rf, ctx) {
    if (rf & 1) {
      ɵɵprojectionDef(_c4);
  ...
  }, "MatExpansionPanelHeader_Template"),
...
__name(_MatExpansionPanelDescription, "MatExpansionPanelDescription");
__publicField(_MatExpansionPanelDescription, "ɵfac", /* @__PURE__ */ __name(function MatExpansionPanelDescription_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _MatExpansionPanelDescription)();
}, "MatExpansionPanelDescription_Factory"));
__publicField(_MatExpansionPanelDescription, "ɵdir", ɵɵdefineDirective({
...
__name(_MatExpansionPanelTitle, "MatExpansionPanelTitle");
__publicField(_MatExpansionPanelTitle, "ɵfac", /* @__PURE__ */ __name(function MatExpansionPanelTitle_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _MatExpansionPanelTitle)();
}, "MatExpansionPanelTitle_Factory"));
__publicField(_MatExpansionPanelTitle, "ɵdir", ɵɵdefineDirective({
...
__name(_MatAccordion, "MatAccordion");
__publicField(_MatAccordion, "ɵfac", /* @__PURE__ */ (() => {
  let ɵMatAccordion_BaseFactory;
  return /* @__PURE__ */ __name(function MatAccordion_Factory(__ngFactoryType__) {
  ...
  }, "MatAccordion_Factory");
})());
__publicField(_MatAccordion, "ɵdir", ɵɵdefineDirective({
  type: _MatAccordion,
  selectors: [["mat-accordion"]],
  contentQueries: /* @__PURE__ */ __name(function MatAccordion_ContentQueries(rf, ctx, dirIndex) {
    if (rf & 1) {
  ...
  }, "MatAccordion_ContentQueries"),
  hostAttrs: [1, "mat-accordion"],
  hostVars: 2,
  hostBindings: /* @__PURE__ */ __name(function MatAccordion_HostBindings(rf, ctx) {
    if (rf & 2) {
      ɵɵclassProp("mat-accordion-multi", ctx.multi);
    }
  }, "MatAccordion_HostBindings"),
  inputs: {
    hideToggle: [2, "hideToggle", "hideToggle", booleanAttribute],
...
__name(_MatExpansionModule, "MatExpansionModule");
__publicField(_MatExpansionModule, "ɵfac", /* @__PURE__ */ __name(function MatExpansionModule_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _MatExpansionModule)();
}, "MatExpansionModule_Factory"));
__publicField(_MatExpansionModule, "ɵmod", ɵɵdefineNgModule({
...
__publicField(_MatExpansionModule, "ɵinj", ɵɵdefineInjector({
